...
Los generadores son una función especial en Python que permiten iterar de forma eficiente y *perezosa*. En lugar de devolver todos los valores de una vez (como con return), los generadores producen valores uno a uno **bajo demanda** mediante la palabra reservada `yield`. Cada vez que se invoca al generador, este devuelve un valor y pausa su ejecución, reanudándola en el siguiente `yield`.
...
**Mas información:**
 + [Generators - Corey Schafer](https://www.youtube.com/watch?v=bD05uGo_sVI&ab_channel=CoreySchafer) 
